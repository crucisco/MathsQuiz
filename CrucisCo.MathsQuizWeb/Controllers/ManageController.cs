...
namespace CrucisCo.MathsQuizWeb.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // GET: /Manage/ChangeOtherUserPassword
        public ActionResult ChangeOtherUserPassword()
        {
            return View();
        }

        //
        // POST: /Manage/ChangeOtherUserPassword
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangeOtherUserPassword(ChangeOtherUserPasswordViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
